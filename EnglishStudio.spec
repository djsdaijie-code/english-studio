...
debug_console = os.environ.get("ENGLISH_STUDIO_DEBUG_CONSOLE", "0") == "1"
...
pyz = PYZ(a.pure)
exe = EXE(
    pyz, a.scripts, [], exclude_binaries=True, name="EnglishStudio", debug=False,
    bootloader_ignore_signals=False, strip=False, upx=False, console=debug_console,
    disable_windowed_traceback=False, argv_emulation=False, target_arch=None,
    codesign_identity=None, entitlements_file=None,
    version=str(project_root / "packaging" / "version_info.txt"),
)
coll = COLLECT(exe, a.binaries, a.datas, strip=False, upx=False, upx_exclude=[], name="EnglishStudio")
