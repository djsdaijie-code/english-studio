...
第一版候选课程已完成 5 个 Level、8 个 Unit、56 个学习日和 176 个核心句子。每个 Unit 为 7 天、22 个新句子：Day 1–4 每天 5–6 句，Day 5 综合场景，Day 6 听写与跟读，Day 7 复习与测评。参数写入课程或 Unit 数据，不写死在程序与 Schema 中。
